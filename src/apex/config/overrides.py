...
GUEST_VARIABLES = frozenset(
    {
        ...
        "APEX_EFFECT_TRACE",
        "APEX_EFI",
        "APEX_ELAN_STATUS_DIAGNOSTICS",
        "APEX_EXTRACTED_HANDLERS",
        "APEX_FAULT",
        "APEX_FINGERPRINT_IMAGE_TEST",
        "APEX_LINUX",
        "APEX_RECOVERY_FIXTURE",
        "APEX_RECOVERY_OBSERVATION",
        "APEX_RECOVERY_REPORT",
        "APEX_TEST_DIGEST",
        "APEX_TEST_DISK",
        "APEX_TEST_PASSWORD_FILE",
        "APEX_TEST_SSH_KEY",
        "APEX_TEST_USER",
        "APEX_UPDATE_ACCESS",
        "APEX_UPDATE_ACTION",
...
TOOLING_VARIABLES = frozenset({"APEX_PYTHON", "APEX_CHAIN_KEY"})
